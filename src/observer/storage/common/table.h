...
public:
    ...
    RC create_index(Trx *trx, const char *index_name,
...
private:
    ...
    RC insert_records(Trx *trx, std::vector<Record *> &record_vector);
...
private:
    ...
    // ! zl
    RC make_records(int value_num, const Value *values,
